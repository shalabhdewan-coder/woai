...
const AGENTS = [
  { id: "models",      label: "Model Tracker",    icon: "◈", focus: "new AI model releases, updates, benchmarks — GPT, Claude, Gemini, Llama, Mistral, Grok" },
  { id: "funding",     label: "Money Flow",        icon: "◆", focus: "AI startup funding rounds, acquisitions, IPOs, investor moves" },
  { id: "research",    label: "Research Radar",    icon: "◉", focus: "AI research papers, breakthroughs, university announcements, scientific discoveries" },
  { id: "tools",       label: "Tool Scout",        icon: "◐", focus: "new AI product launches, developer tools, APIs, SaaS releases" },
  { id: "geopolitics", label: "Geo Intelligence",  icon: "◑", focus: "AI regulation, US/China/EU policy, export controls, government AI strategy" },
  { id: "biotech",     label: "Bio+AI Monitor",    icon: "◒", focus: "AI in healthcare, drug discovery, longevity, biotech, CRISPR, synthetic biology" },
];
